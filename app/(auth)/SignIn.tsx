import { View, Text, Platform, StyleSheet, TextInput, KeyboardAvoidingView, TouchableOpacity, Pressable, StatusBar, ScrollView , Keyboard} from "react-native";
                ...
                <ScrollView style={{ flex: 1, backgroundColor:"white" }}>
                    ...
                    <View>
                        <View style={{ marginHorizontal: 16 }}>
                            <Text style={{ color: "#0EA5E9", fontSize: 32, lineHeight: 32, letterSpacing: 0, fontFamily: "CustomFont", fontWeight: 600 }}>Sign In</Text>
                    ...
                    <View style={{
                        marginBottom: keyboardShow ? 0 : 30,
                        gap:5
                    }}>
                        <TouchableOpacity
                            style={
                        ...
                        >
                            <Text style={{ color: "white", paddingVertical: 10, flex: 0, justifyContent: "center", textAlign: "center" }}>LogIn</Text>
                        </TouchableOpacity>
